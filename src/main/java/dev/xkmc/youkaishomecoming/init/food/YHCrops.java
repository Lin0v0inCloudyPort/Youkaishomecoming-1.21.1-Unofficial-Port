...
public enum YHCrops {
	...
	RED_GRAPE(PlantType.GRAPE, 8, "red_grape_seeds", "red_grape"),
	BLACK_GRAPE(PlantType.GRAPE, 4, "black_grape_seeds", "black_grape"),
	WHITE_GRAPE(PlantType.GRAPE, 8, "white_grape_seeds", "white_grape"),
	;
	...
	YHCrops(PlantType type, int rarity, @Nullable String seedName, @Nullable String fruit) {
		...
		this.configKey = ResourceKey.create(Registries.CONFIGURED_FEATURE, GensokyoLegacy.loc(name));
		this.placementKey = ResourceKey.create(Registries.PLACED_FEATURE, GensokyoLegacy.loc(name));
	...
	public static BlockEntry<Block> createBag(String id) {
		return GensokyoLegacy.REGISTRATE
	...
	public enum PlantType {
		CROP((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
				...
				.register(),
				(name, crop) -> GensokyoLegacy.REGISTRATE.block("wild_" + name, p -> new VanillaBush(BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION)))
		...
		CROSS((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
						new YHCropBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT), crop::getSeed))
		...
		COFFEA((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
				...
				.register(),
				(name, crop) -> GensokyoLegacy.REGISTRATE.block("wild_" + name, p -> new WildCoffeaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION)))
		...
		TEA((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
		...
		UDUMBARA((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
				...
				.register(),
				(name, crop) -> GensokyoLegacy.REGISTRATE.block("wild_" + name, p ->
		...
		MANDRAKE((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
						new YHCropBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT), crop::getSeed))
				.blockstate((ctx, pvd) -> YHCropBlock.buildCrossModel(ctx, pvd, name))
		...
		CUCUMBER((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
						new dev.xkmc.youkaishomecoming.content.block.plant.rope.CucumberCropBlock(
								BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT), crop::getSeed, crop::getFruits))
				.blockstate((ctx, pvd) -> dev.xkmc.youkaishomecoming.content.block.plant.rope.RopeCropJsonGen.buildPlantModel(ctx, pvd, name))
				.loot((pvd, block) -> dev.xkmc.youkaishomecoming.content.block.plant.rope.RopeCropJsonGen.buildPlantLoot(pvd, block, crop))
				.register(),
				(name, crop) -> GensokyoLegacy.REGISTRATE.block("wild_" + name, p -> new VanillaBush(BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION)))
						.blockstate((ctx, pvd) -> YHCropBlock.buildWildModel(ctx, pvd, crop))
						.loot((ctx, pvd) -> YHCropBlock.buildWildLoot(ctx, pvd, crop))
						.item().tag(ModTags.WILD_CROPS_ITEM).model((ctx, pvd) -> pvd.generated(ctx, pvd.modLoc("block/plants/" + name + "/wild_" + name))).build()
						.tag(ModTags.WILD_CROPS)
						.register()
		),

		GRAPE((name, crop) -> GensokyoLegacy.REGISTRATE.block(name, p ->
						new dev.xkmc.youkaishomecoming.content.block.plant.grape.GrapeCropBlock(
								BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT), crop))
				.blockstate((ctx, pvd) -> dev.xkmc.youkaishomecoming.content.block.plant.grape.GrapeVineSet.buildPlantModel(ctx, pvd, name))
				.loot((pvd, block) -> dev.xkmc.youkaishomecoming.content.block.plant.grape.GrapeVineSet.buildPlantLoot(pvd, (dev.xkmc.youkaishomecoming.content.block.plant.grape.GrapeCropBlock) block, crop))
				.register(),
				(name, crop) -> GensokyoLegacy.REGISTRATE.block("wild_" + name,
						p -> name.equals("black_grape")
								? new WildVineBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION))
								: new VanillaBush(BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION)))
						.blockstate((ctx, pvd) -> dev.xkmc.youkaishomecoming.content.block.plant.grape.GrapeVineSet.buildWildModel(ctx, pvd, crop))
						.loot((ctx, pvd) -> YHCropBlock.buildWildLoot(ctx, pvd, crop))
						.item().tag(ModTags.WILD_CROPS_ITEM).model((ctx, pvd) -> pvd.generated(ctx, pvd.modLoc("block/plants/grape/wild_" + name))).build()
						.tag(ModTags.WILD_CROPS)
						.register()
		),
		;
